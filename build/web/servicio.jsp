                                ...
                                <div class="collapse navbar-collapse tm-nav" id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link tm-nav-link" href="#">Alta Servicio Turístico<span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid">
                ...
                <section class="row tm-mb-1">
                    <div class="col-12 text-center mx-auto tm-about-box">
                        <h2 class="tm-text-primary tm-my-1 tm-mb-5 tm-intro-text">Alta Servicio Turístico</h2>
                    </div>
                </section>
                <div class="row tm-mb-10 tm-contact-row mx-auto">
                    <div class="col-lg-12 ml-auto ">
                        <div class="tm-contact-form-wrap">
                            <form id="contact-form" action="SvServicio" method="POST" class="tm-contact-form">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="contact-select" name="nombre" placeholder="Seleccione" required="">
                                        ...
                                        <option value="Pasaje de avion">Pasaje de avion</option>
                                ...
                                <div class="form-group">
                                    <label>Descripción: </label><input type="text" name="descripcion" class="form-control rounded-0" placeholder="Ingrese descripción" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Destino: </label><input type="text" name="destino" class="form-control rounded-0" placeholder="Ingrese destino" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Costo: </label><input type="number" name="costo" class="form-control rounded-0" placeholder="Ingrese costo" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Fecha: </label><input type="date" name="fecha" class="form-control rounded-0" required="" />
                                </div>
