                                ...
                                <div class="collapse navbar-collapse tm-nav" id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link tm-nav-link" href="#">Alta Empleado<span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid">
                ...
                <section class="row tm-mb-1">
                    <div class="col-12 text-center mx-auto tm-about-box">
                        <h2 class="tm-text-primary tm-my-1 tm-mb-5 tm-intro-text">Alta Empleado</h2>
                    </div>
                </section>
                <div class="row tm-mb-10 tm-contact-row mx-auto">
                    <div class="col-lg-12 ml-auto ">
                        <div class="tm-contact-form-wrap">
                            <form id="contact-form" action="SvEmpleado" method="POST" class="tm-contact-form">
                                ...
                                <div class="form-group">
                                    <label>Cargo: </label><input type="text" name="cargo" class="form-control rounded-0" placeholder="Ingrese cargo" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Sueldo: </label><input type="number" name="sueldo" class="form-control rounded-0" placeholder="Ingrese sueldo" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Fecha de nacimiento: </label><input type="date" name="fechaNac" class="form-control rounded-0" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Nombre de usuario: </label><input type="text" name="nombreUsu" class="form-control rounded-0" placeholder="Ingrese nombre de usuario" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Contraseña: </label><input type="password" name="contrasenia" class="form-control rounded-0" placeholder="Ingrese contraseña" required="" />
                                </div>

                                <div class="form-group mb-0">
                                    <button type="submit" class="btn btn-3 rounded-0 d-block ml-auto">Cargar Empleado</button>
                                </div>
                            </form>
                        </div>
                    </div>
