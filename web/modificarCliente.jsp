                                ...
                                <div class="collapse navbar-collapse tm-nav" id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link tm-nav-link" href="#">Modificar Cliente<span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid">
                ...
                <section class="row tm-mb-1">
                    <div class="col-12 text-center mx-auto tm-about-box">
                        <h2 class="tm-text-primary tm-my-1 tm-mb-5 tm-intro-text">Modificar Cliente</h2>
                    </div>
                </section>
                <div class="row tm-mb-10 tm-contact-row mx-auto">
                    <div class="col-lg-12 ml-auto ">
                        <div class="tm-contact-form-wrap">
                            <form id="contact-form" action="SvModificarCliente" method="get" class="tm-contact-form">
                                <div class="form-group">
                                    <label>Nombre: </label><input type="text" name="nombre" class="form-control rounded-0" value="<%=cli.getNombre()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Apellido: </label><input type="text" name="apellido" class="form-control rounded-0" value="<%=cli.getApellido()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Dirección: </label><input type="text" name="direccion" class="form-control rounded-0" value="<%=cli.getDireccion()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>DNI: </label><input type="text" name="dni" class="form-control rounded-0" value="<%=cli.getDni()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Nacionalidad: </label><input type="text" name="nacionalidad" class="form-control rounded-0" value="<%=cli.getNacionalidad()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Celular: </label><input type="text" name="celular" class="form-control rounded-0" value="<%=cli.getCelular()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <label>Email: </label><input type="email" name="email" class="form-control rounded-0" value="<%=cli.getEmail()%>" required="" />
                                </div>
                                <div class="form-group">
                                    <% String nacimiento = String.format("%1$tY-%1$tm-%1$td", cli.getFecha_nac());%>
                                ...
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn btn-3 rounded-0 d-block ml-auto">Modificar Cliente</button>
                                </div>
                            </form>
                        </div>
                    </div>
