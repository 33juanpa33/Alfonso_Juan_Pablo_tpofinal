...
<html lang="es">
    ...
    <body>
        ...
        %>
        <%
            Paquete_turistico paq = (Paquete_turistico) misession.getAttribute("paquete");
        %>
                                ...
                                <div class="collapse navbar-collapse tm-nav" id="navbarNav">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link tm-nav-link" href="#">Modificar Paquete Turístico<span class="sr-only">(current)</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link tm-nav-link" href="paqueteAdmin.jsp">Administrar Paquetes Turisticos</a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="container-fluid">
                ...
                <section class="row tm-mb-1">
                    <div class="col-12 text-center mx-auto tm-about-box">
                        <h2 class="tm-text-primary tm-my-1 tm-mb-5 tm-intro-text">Modificar Paquete Turístico</h2>
                    </div>
                </section>
                ...
                <div class="row tm-mb-10 tm-contact-row mx-auto">
                    <div class="col-lg-12 ml-auto ">
                        <div class="tm-contact-form-wrap">
                            <form id="contact-form" action="SvModificarPaquete" method="get" class="tm-contact-form" onsubmit="return verificar();">
                                <div class="form-group">
                                    ...
                                    <label>
                                        <input type="checkbox" name="codigo" value="<%=serv.getCodigo()%>" 
                                               <% for (Servicio servMarcado : paq.getListaServicios()) {
                                                       if (servMarcado.getCodigo().equals(serv.getCodigo())) { %>checked <% break ;
                                                }
                                            } %> >
                                ...
                                <input type="hidden" name="codigoPaq" value="<%=paq.getCodigo() %>">
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn btn-3 rounded-0 d-block ml-auto">Modificar Paquete Turístico</button>
                                </div>
                            </form>
                        </div>
                    </div>
